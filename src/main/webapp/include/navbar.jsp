...
<nav id="header">
    ...
    <div>
        <ul id="navbar">
            ...
            <li><a class="menu-item" href="/index.jsp" data-menu="home">Home</a></li>
            <li><a class="menu-item" href="/Page/pageIndex" data-menu="shop">Shop</a></li>
            <li><a class="menu-item" href="/Blog.jsp" data-menu="blog">Blog</a></li>
            <li><a class="menu-item" href="/About.jsp" data-menu="about">About</a></li>
            <li><a class="menu-item" href="/Contact.jsp" data-menu="contact">Contact</a></li>
            <c:choose>
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in py-2 mt-3"
                            ...
                            <c:choose>
                                <c:when test="${user.getAccount().getType()== 1}">
                                    <a class="dropdown-item small" href="/Admin/Default?iIndex=1">
