          ...
          <div class="form-inline">
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="/Admin/Default?iIndex=1">User Management</a>
                  <a class="dropdown-item" href="/Admin/Default?iIndex=2">Order Management</a>
                  <a class="dropdown-item" href="/Admin/Default?iIndex=3">Product Management</a>
                </div>
              </div>
          </div>
        </header><!-- sect-heading -->
